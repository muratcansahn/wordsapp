...
import { Header } from '@/components/screen/paywall-double-lavalamp/components/header';
import { FeatureList } from '@/components/screen/paywall-double-lavalamp/components/feature-list';
import { TermsText } from '@/components/screen/paywall-double-lavalamp/components/terms-text';
import { PurchaseButton } from '@/components/screen/paywall-double-lavalamp/components/purchase-button';
import RadioButton from '@/components/common/buttons/radio-button';
import { Colors } from '@/constants/Colors';
import { useTheme } from '@/hooks/theme/useTheme';
import LavaLamp from '@/components/screen/paywall-double-lavalamp/components/lava-lamp';
